...
local DateInterval = Class('DateInterval', Date)
local DateFormat = Class('DateFormat')

AddOn.components.Models.Date = Date
AddOn.components.Models.DateInterval = DateInterval
AddOn.components.Models.DateFormat = DateFormat
